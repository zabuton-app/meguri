...
export const en: Record<TranslationKey, string> = {
  ...
  "shortcuts.inspectFocused": "Open focused item's details (no playback)",
  ...
  "player.audio.close": "Close player",
  "player.audio.openDetail": "Open details",
  ...
  "settings.audioSpectrumPatternLissajous": "Lissajous figure",
