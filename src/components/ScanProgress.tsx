...
export function ScanProgress({
  ...
  return (
    <div className="fixed bottom-[max(2.5rem,calc(1rem+var(--meguri-player-bar-inset)))] left-4 z-30 w-72 rounded-md border border-border bg-surface px-3 py-2 shadow-lg shadow-black/25">
