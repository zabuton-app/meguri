// shadcn/ui-based Carousel (embla-carousel-react). Colors use our semantic tokens.
...
>(
  (
    ...
    React.useEffect(() => {
      if (!api) return;
      // This is state syncing tied to initializing the embla subscription; as the initial sync of an external subscription, setState within this effect is legitimate, so it is allowed.
